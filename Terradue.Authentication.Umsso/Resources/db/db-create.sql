...
INSERT INTO auth (`identifier`, `name`, `description`, `type`, `enabled`) VALUES ('umsso', 'UM-SSO authentication', 'UM-SSO authentication allows users to identify themselves using ESA um-sso provider.', 'Terradue.Authentication.Umsso.UmssoAuthenticationType, Terradue.Authentication.Umsso', '1');
-- RESULT
